...
class GraphicsConstants {
    ...
    public static final Color C_START = Color.GREEN;
    ...
    public static final Color C_IMAGE = Color.MAGENTA;
    public static final Color C_ARRIVE = Color.RED;
    public static final Color C_ARRIVE_DIR = Color.YELLOW;
    public static final Color C_BORDER = Color.DARK_GRAY;
