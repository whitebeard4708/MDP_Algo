...
public class RobotConstants {
    ...
    public static final double LEFT_F_V = 3;
    public static final double LEFT_F_H = 2.7;
    public static final double RIGHT_F_V = 2.9; 
    public static final double RIGHT_F_H = 2.9;
    public static final double LEFT_B_V = 3.1;
    public static final double LEFT_B_H = 2.8;
    public static final double RIGHT_B_V = 2.7;
    public static final double RIGHT_B_H = 3.3;
    
    
    // TUT WOOD FLOOR
    /*
    public static final double LEFT_F_V = 3.1; // 
    public static final double LEFT_F_H = 2.8; //
    public static final double RIGHT_F_V = 2.7; 
    public static final double RIGHT_F_H = 3;
    public static final double LEFT_B_V = 3.1;
    public static final double LEFT_B_H = 2.9;
    public static final double RIGHT_B_V = 2.6;
    public static final double RIGHT_B_H = 3.3;
    */
    /*
    public static final double LEFT_F_V = 3.1;
    public static final double LEFT_F_H = 3;
    public static final double RIGHT_F_V = 3;
    public static final double RIGHT_F_H = 3;
    public static final double LEFT_B_V = 3;
    public static final double LEFT_B_H = 2.7;
    public static final double RIGHT_B_V = 2.8;
    public static final double RIGHT_B_H = 3.3;
    */
